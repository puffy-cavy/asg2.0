		...
		stage('nonprod power scheduler'){
			...
			steps{
				script{
					...
					ACCOUNT_PARAMS = input(message: 'The ECS cluster modified is in Prod/ Non-prod account?', id: 'accountChoice',
                	...
                	sh './aws-setup-credentials.sh' //cannot call the shell script without source
